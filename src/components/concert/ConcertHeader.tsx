      ...
      >
        ...
        <div className="about flex flex-col gap-4">
          ...
          <p className="text-text-sub">
            ...
            방문해주세요. 저는 지금 긴 글이 필요합니다. 윤도현 밴드, 유다빈 밴드의 뒤를 이을 변수연
            밴드 통칭 BB. 얼굴에 바르시면 안 됩니다. 아무래도 화장품은 아니구요. 오늘은 눈비가
            오네요. 춥긴 한데 옷을 답지 않게 따뜻하게 입었더니 자꾸 덥네요. 몸은 더운데 얼굴은 추운
            그거 아시나요? 마스크를 쓰고 5분 정도 걸었더니 제 뜨거운 입김에 속눈썹과 옆 더듬이가
            촉촉해지더군요. 아마도 조금 더 추웠으면 꽝꽝 얼어버렸을지도 몰라요. 조금 위험하네요. 이
            정도 길이면 충분한거 같아요. 감기 조심하세요. 메리 크리스마스.
          </p>
        </div>
